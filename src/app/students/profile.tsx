          ...
          <View style={styles.card}>
            ...
            {profile.student_profile && (
              <>
                ...
                <Text style={styles.detail}>Class: {profile.student_profile.class_name}</Text>
                <Text style={styles.detail}>Roll No: {profile.student_profile.roll_number}</Text>
                <Text style={styles.detail}>Admission No: {profile.student_profile.admission_number}</Text>
              </>
            )}
